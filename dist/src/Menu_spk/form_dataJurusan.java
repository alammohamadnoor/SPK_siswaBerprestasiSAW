...
public class form_dataJurusan extends javax.swing.JFrame {
    private Connection conn = new koneksi().connect();
    private DefaultTableModel TabelJurusan;
    ...
    public void print () {
        try {
            ...
            (form_dataJurusan.class.getResourceAsStream("/Report/report_dataJurusan.jasper"), par, conn);
    ...
    protected void datatable(){
         Object [] Baris = {"ID Jurusan","Nama Jurusan","Nama Kajur","Email","Alamat","No. Telepon"};
            TabelJurusan = new DefaultTableModel(null,Baris);
            String cariitem = txtcari.getText();
            
            try{
                String sql = "SELECT * FROM tb_jurusan where id_jurusan like '%"+cariitem+"%' or nama_jurusan like '%"+cariitem+"%'";
                Statement stat = conn.createStatement();
                ResultSet hasil = stat.executeQuery(sql);
                while (hasil.next()){
                    TabelJurusan.addRow(new Object [] {
                        hasil.getString(1),
                        hasil.getString(2),
                        hasil.getString(3),
                        hasil.getString(4),
                ...
                tbjurusan.setModel(TabelJurusan);
            } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        txtnmjurusan = new javax.swing.JTextField();
        ...
        txtnmkajur = new javax.swing.JTextField();
        ...
        jLabel1.setText("Masukkan Data Jurusan dengan benar !");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 50, 260, -1));

        jLabel5.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel5.setText("ID Jurusan");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 90, 110, -1));

        txtnmjurusan.setFont(new java.awt.Font("SansSerif", 0, 14)); // NOI18N
        txtnmjurusan.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 2, 0, new java.awt.Color(0, 0, 0)));
        txtnmjurusan.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtnmjurusanKeyPressed(evt);
            }
        });
        jPanel1.add(txtnmjurusan, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 170, 400, 30));
        ...
        tbjurusan.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        jLabel11.setText("ID/Nama Jurusan");
        ...
        txtidjurusan.setFont(new java.awt.Font("SansSerif", 0, 14)); // NOI18N
        txtidjurusan.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 2, 0, new java.awt.Color(0, 0, 0)));
        txtidjurusan.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtidjurusanKeyPressed(evt);
            }
        });
        jPanel1.add(txtidjurusan, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 110, 190, 30));

        jPanel2.setBackground(new java.awt.Color(240, 189, 108));
        jPanel2.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jPanel4.setBackground(new java.awt.Color(34, 105, 54));
        jPanel2.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 380, 20, 50));
        ...
        jPanel2.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 380, 170, 50));
        ...
        jLabel7.setText("Nama Kepala Jurusan");
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 210, 170, -1));

        txtnmkajur.setFont(new java.awt.Font("SansSerif", 0, 14)); // NOI18N
        txtnmkajur.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 2, 0, new java.awt.Color(0, 0, 0)));
        txtnmkajur.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtnmkajurKeyPressed(evt);
            }
        });
        jPanel1.add(txtnmkajur, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 230, 400, 30));
        ...
        jPanel1.add(txtemail, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 290, 400, 30));
    ...
    private void tbjurusanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbjurusanMouseClicked
        int bar = tbjurusan.getSelectedRow();
        String a = TabelJurusan.getValueAt(bar, 0). toString();
        String b = TabelJurusan.getValueAt(bar, 1). toString();
        String c = TabelJurusan.getValueAt(bar, 2). toString();
        String d = TabelJurusan.getValueAt(bar, 3). toString();
        String e = TabelJurusan.getValueAt(bar, 4). toString();
        String f = TabelJurusan.getValueAt(bar, 5). toString();

        txtidjurusan.setText(a);
        txtnmjurusan.setText(b);
        txtnmkajur.setText(c);
        txtemail.setText(d);
        txtalamat.setText(e);
        txtnotelp.setText(f);
    ...
    private void beditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_beditActionPerformed
        try {
            String sql = "update tb_jurusan set nama_jurusan=?,nama_kajur=?,email=?,alamat=?,no_telp=?  where id_jurusan='"+txtidjurusan.getText()+"'";
            PreparedStatement stat = conn.prepareStatement(sql);
            stat.setString(1, txtnmjurusan.getText());
            stat.setString(2, txtnmkajur.getText());
    ...
    private void bdeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bdeleteActionPerformed
        ...
        if (ok==0){
            String sql = "delete from tb_jurusan where id_jurusan= '"+txtidjurusan.getText()+"'";
            try {
                PreparedStatement stat = conn.prepareStatement(sql);
                stat.executeUpdate();
    ...
    private void bsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bsaveActionPerformed
        String sql = "insert into tb_jurusan values (?,?,?,?,?,?)";
        try {
            PreparedStatement stat = conn.prepareStatement(sql);
            stat.setString(1, txtidjurusan.getText());
            stat.setString(2, txtnmjurusan.getText());
            stat.setString(3, txtnmkajur.getText());
    ...
    private void txtidjurusanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtidjurusanKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtidjurusanKeyPressed
    ...
    private void txtnmkajurKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtnmkajurKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtnmkajurKeyPressed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(form_dataJurusan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new form_dataJurusan().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField txtnmjurusan;
    private javax.swing.JTextField txtnmkajur;
